# Contributing to fasster

This outlines how to propose a change to fasster. For more detailed info
...
Conduct](https://fasster.tidyverts.org/dev/CODE_OF_CONDUCT.md). By
