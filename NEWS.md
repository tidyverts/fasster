...
* **FASSTER model implementation**: Fast Additive Switching of Seasonality, 
  Trend and Exogenous Regressors (FASSTER) is a state space model designed for 
  forecasting time series with multiple seasonal patterns. The model extends 
  traditional state space models by introducing a switching component to the 
  measurement equation, enabling flexible modeling of complex seasonal patterns, 
